...
#
clear
MAKEFONT=/sdcard/MidnightMain/MidnightFonts/MidnightMake
clear
...
case "$CHOICE" in
	"$CHOICE")
		LINK="$( cat /sdcard/MidnightMain/MidnightFonts/MidnightMake/'DONT-DELETE-2' | xargs | cut -d ' ' -f $CHOICE )"
		FONT2="$( cat /sdcard/MidnightMain/MidnightFonts/MidnightMake/'DONT-DELETE' | xargs | cut -d '.' -f $CHOICE | xargs )"
