...
#Set up necessary busybox utils
...
then
	echo "Testing..."
	MIDFONT=/sdcard/'MidnightMain(Beta)'/MidnightFonts
else
	echo "Testing2....."
...
then
	echo "***************************************************" >> $LOGFILE
	echo "******** MidnightCore: MidnightFonts(beta)********" >> $LOGFILE
	...
	other_steps () {
		...
		then
			...
			log	_handler "Magisk img not successfully mounted!"
		fi	
